...
import com.curiocity.client.MyRequestFactory.HelloWorldRequest;
import com.curiocity.client.MyRequestFactory.MessageRequest;
import com.curiocity.shared.MessageProxy;

public class CurioCityWidget extends Composite {
  ...
  interface CurioCityUiBinder extends UiBinder<Widget, CurioCityWidget> {
  }

  private static CurioCityUiBinder uiBinder = GWT.create(CurioCityUiBinder.class);
